...
- **Metadata** — always include, regardless of whether the spec has a visual surface: a summary of test output (what ran, what passed), the list of migration files added/changed, links to any [Notion board](https://app.notion.com/p/87fae8a2ed054f2c874201e827639bd8) rows opened or moved to `done` during the run, and the final Session checklist from the state file.
